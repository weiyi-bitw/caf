...
public class GroupAttractors2 {
	...
	public static void main(String[] arg) throws Exception {
		...
		String path = "/home/weiyi/workspace/javaworks/caf/output/noMinSize/coad.gse14333.rownorm.z8/";
		if(!path.endsWith("/")){
			path = path + "/";
		}
		...
		*/	
		...
		for(int i = 0; i < N; i++){
			...
			GeneSet gs = new GeneSet(a.getName(), metaIdx.toArray(new ValIdx[0]), a.strength);
			if(gs.size() < minSize){
